...
| `openlogi-hid/src/permissions.rs` | `IOHIDCheckAccess` / `IOHIDRequestAccess` (the prompting half of Input Monitoring) and a query-only `+[CBManager authorization]` read for the agent watcher |
