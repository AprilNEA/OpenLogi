...
pub use write::{
    Dpi, DpiCapabilities, DpiInfo, FeatureEntry, FirmwareEntityEntry, HapticWaveform,
    HidppFeatureErrorKind, HidppOperation, LITRA_BEAM_PRODUCT_ID, LITRA_GLOW_PRODUCT_ID,
    LightCommand, LightingMethod, LitraModel, ReprogControlEntry, ScrollReportingTarget,
    ScrollResolution, ScrollWheelMode, WriteError, apply_litra, clear_haptic_feature_cache,
    ...
    get_smartshift_status_on, matches_litra, play_haptic, play_haptic_on, read_battery_raw,
