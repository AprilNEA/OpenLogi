...
pub use host::{
    ...
    enumerate, enumerate_standalone, get_backlight, get_crown_info, get_crown_mode, get_dpi,
    get_dpi_info, get_scroll_wheel_mode, get_smartshift_status, list_pairing_receivers,
    play_haptic, read_battery_raw, set_backlight_enabled, set_crown_mode, set_dpi, set_fn_lock,
    set_keyboard_color, set_keyboard_color_with, set_scroll_inversion, set_scroll_resolution,
