...
pub use session::gesture::{
    ...
    run_capture_session_with_registry, run_capture_session_with_registry_spec,
...
pub use write::{
    ...
    WriteError, apply_litra, clear_haptic_feature_cache, commands_for_light_settings,
    dump_features, dump_reprog_controls, encode_litra_command, ensure_haptics_armed_on,
    get_backlight, get_dpi, get_dpi_info, get_dpi_info_on, get_scroll_wheel_mode,
