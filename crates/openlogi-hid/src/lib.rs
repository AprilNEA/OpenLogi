...
pub use host::{
    ...
    enumerate, enumerate_standalone, get_backlight, get_dpi, get_dpi_info, get_haptic_state,
    get_scroll_wheel_mode, get_smartshift_status, list_pairing_receivers, play_haptic,
    read_battery_raw, set_backlight_enabled, set_dpi, set_fn_lock, set_haptic_intensity,
