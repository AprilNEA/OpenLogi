...
pub use write::{
    ...
    HapticCapabilities, HapticConfiguration, HapticIntensity, HapticWaveform,
    ...
    get_dpi_info, get_dpi_info_on, get_haptic_state, get_scroll_wheel_mode,
    ...
    set_backlight_enabled, set_dpi, set_dpi_on, set_fn_lock, set_fn_lock_on, set_haptic_intensity,
