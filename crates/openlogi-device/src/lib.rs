...
pub use session::gesture::{
    ...
    HoldRelease, PendingCaptureRestore, run_capture_session,
...
pub use write::{
    ...
    apply_litra, cached_sensor_dpi, commands_for_light_settings, dump_features,
    dump_firmware_entities, dump_reprog_controls, encode_litra_command, ensure_haptics_armed_on,
    find_litra, get_backlight, get_dpi, get_dpi_info, get_dpi_info_on, get_dpi_on,
    ...
    read_battery_raw, remember_sensor_dpi, set_backlight_enabled, set_dpi, set_dpi_on, set_fn_lock,
