...
pub use write::{
    ...
    OnboardProfilesInfo, ReprogControlEntry, ScrollReportingTarget, ScrollResolution,
    ScrollWheelMode, WriteError, apply_litra, clear_haptic_feature_cache,
    commands_for_light_settings, dump_features, dump_firmware_entities,
    dump_onboard_current_profile, dump_onboard_profile_bindings, dump_onboard_profiles_info,
    dump_onboard_profiles_sector, dump_reprog_controls, encode_litra_command,
    ensure_haptics_armed_on, find_litra, get_backlight, get_dpi, get_dpi_info, get_dpi_info_on,
    ...
    read_battery_raw, read_onboard_profile_bindings_on, set_backlight_enabled, set_dpi, set_dpi_on,
