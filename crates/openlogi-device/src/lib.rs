...
pub use write::{
    DisableKeysMask, DisableKeysState, Dpi, DpiCapabilities, DpiInfo, FeatureEntry, FirmwareEntity,
    FirmwareEntityInfo, HapticWaveform, HidppFeatureErrorKind, HidppOperation,
    LITRA_BEAM_PRODUCT_ID, LITRA_GLOW_PRODUCT_ID, LightCommand, LightingMethod, LitraDescriptor,
    LitraModel, ReprogControlEntry, ScrollReportingTarget, ScrollResolution, ScrollWheelMode,
    WriteError, apply_litra, commands_for_light_settings, dump_features, dump_firmware_entities,
    dump_reprog_controls, encode_litra_command, ensure_haptics_armed_on, find_litra, get_backlight,
    get_disable_keys, get_disable_keys_on, get_dpi, get_dpi_info, get_dpi_info_on,
    ...
    read_battery_raw, set_backlight_enabled, set_disable_keys, set_disable_keys_on, set_dpi,
...
pub mod test_support {
    pub use crate::channel::scripted::{
        ScriptedRawHidHandle, publish_scripted_channel, scripted_shared_channel,
    };
}
