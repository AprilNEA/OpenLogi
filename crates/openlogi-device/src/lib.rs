...
pub use write::{
    ...
    ReprogControlEntry, ScrollReportingTarget, ScrollResolution, ScrollWheelMode,
    WheelCapabilities, WriteError, apply_litra, commands_for_light_settings, dump_features,
    dump_firmware_entities, dump_reprog_controls, encode_litra_command, ensure_haptics_armed_on,
    find_litra, get_backlight, get_backlight_on, get_dpi, get_dpi_info, get_dpi_info_on,
    get_scroll_wheel_mode, get_scroll_wheel_mode_on, get_smartshift_status,
    get_smartshift_status_on, get_wheel_capabilities, get_wheel_capabilities_on,
