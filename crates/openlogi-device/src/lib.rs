...
pub use write::{
    ...
    get_backlight_on, get_disable_keys, get_disable_keys_on, get_dpi, get_dpi_info,
    get_dpi_info_on, get_scroll_wheel_mode, get_scroll_wheel_mode_on, get_smartshift_status,
