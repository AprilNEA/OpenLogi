...
pub use write::{
    ...
    HapticWaveform, HidppFeatureErrorKind, HidppOperation, HostOperatingSystem, HostPlatformApply,
    ...
    set_keyboard_color_with, set_keyboard_color_with_on, set_native_host_platform,
    set_native_host_platform_on, set_scroll_inversion, set_scroll_inversion_on,
