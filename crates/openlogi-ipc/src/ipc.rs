...
/// v30: `ButtonId::KeyBacklightDown`/`KeyBacklightUp` and
///      `Action::BrightnessUp`/`BrightnessDown` appended — the MX Mechanical
///      backlight keys become divertable slots bindable to display-brightness
///      actions.
