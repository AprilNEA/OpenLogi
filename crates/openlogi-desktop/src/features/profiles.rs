...
/// Build the Buttons workspace's profile selector. The foreground app may
/// change which profile is active, but never changes which profile this editor
/// has open.
