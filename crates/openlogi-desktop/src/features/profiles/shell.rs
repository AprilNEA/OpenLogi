    ...
    h_flex()
        ...
        .child(
            div()
                ...
                .child(rust_i18n::t!("profiles.profile")),
        )
        .child(
            h_flex()
...
fn profile_options_popover(
    ...
    Popover::new(format!("{id_base}:profile-options-popover"))
        ...
        .content(move |_state, _window, cx| {
            ...
            compact_panel(pal)
                .w(px(224.))
                .child(title(rust_i18n::t!("profiles.profile_options"), pal))
                .child(divider(pal))
                .child(
                    MenuRow::new(format!("{id_base}:remove-profile"))
                        ...
                        .child(
                            h_flex()
                                ...
                                .child(rust_i18n::t!("profiles.remove_profile_dialog")),
                        )
