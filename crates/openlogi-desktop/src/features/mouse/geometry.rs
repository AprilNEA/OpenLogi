...
fn map_slot_name(name: &str) -> Option<MouseControlId> {
    match name {
        ...
        // MX Ergo names its precision-mode/DPI-shift button after its
        // Options+ function rather than "DPI" or "ModeShift".
...
mod tests {
    ...
    fn dpi_slot_names_map_to_dpi_toggle_button() {
        ...
        // MX Ergo's precision-mode/DPI-shift button uses this slot name.
        assert_eq!(
