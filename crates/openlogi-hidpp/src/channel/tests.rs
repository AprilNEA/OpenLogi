...
/// [`a_request_waits_while_the_same_header_is_in_flight`] above. #1128
/// reported this as capture sessions restarting ("capture session ended
/// unexpectedly") alternating with inventory retiring the very channel
...
/// [`RootFeature::new_secondary`]/[`crate::device::Device::new_secondary`]
/// give capture's session-setup and liveness calls — carries a different
/// correlation key and must not queue behind the primary id's in-flight
/// request, closing that race.
#[test]
