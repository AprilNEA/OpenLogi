...
/// receivers.
///
/// `0xc53f` and `0xc547` are Lightspeed receivers (bundled with G-series
/// wireless mice — `0xc53f` with the G305, `0xc547` with the G502 X
/// LIGHTSPEED). They are not Unifying receivers, but they expose the same
