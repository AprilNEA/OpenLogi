...
use crate::{
    ...
    feature::{
        ...
        device_type_and_name::DeviceTypeAndNameFeature, extended_dpi::ExtendedDpiFeature,
        ...
        mouse_pointer::MousePointerFeature, multi_platform::MultiPlatformFeature,
        report_rate::ReportRateFeature, reprog_controls::ReprogControlsFeature, root::RootFeature,
        sidetone::SidetoneFeature, smartshift::SmartShiftFeature,
        smartshift_enhanced::SmartShiftEnhancedFeature, thumbwheel::ThumbwheelFeature,
        unified_battery::UnifiedBatteryFeature, vertical_scrolling::VerticalScrollingFeature,
