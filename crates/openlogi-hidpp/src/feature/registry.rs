...
use crate::{
    ...
    feature::{
        ...
        enable_hidden_features::EnableHiddenFeaturesFeature,
        ...
        force_sensing_button::ForceSensingButtonFeature,
...
static KNOWN_FEATURES: LazyLock<HashMap<u16, KnownFeature>> = LazyLock::new(|| {
    ...
    0x19c0 "ForceSensingButton" => ForceSensingButtonFeature,
    ...
    0x1e00 "EnableHiddenFeatures" => EnableHiddenFeaturesFeature,
