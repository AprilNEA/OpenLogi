...
pub struct DeviceConfig {
    ...
    /// Host-side speed adjustment for native horizontal-scroll events. This is
    /// distinct from [`Self::thumbwheel_sensitivity`], which applies only to
    /// HID++ feature `0x2150` thumb wheels.
    #[serde(
        default,
