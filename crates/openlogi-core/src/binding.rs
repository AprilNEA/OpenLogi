...
pub use swipe::{
    GESTURE_CONTACT_SETTLE, GESTURE_HOLD_FOR_SWIPE, GESTURE_SWIPE_DEADZONE,
    GESTURE_SWIPE_THRESHOLD, GestureTrace, RawMotionSample, SwipeAccumulator, detect_swipe,
};
