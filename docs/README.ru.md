...
> [!CAUTION]
> **У OpenLogi нет криптовалютного токена.** Мы никогда не создавали, не одобряли и не поддерживали никакой токен — ни на pump.fun, ни где-либо ещё — и никогда не будем. Любой токен, использующий название или логотип OpenLogi, — мошенничество и не имеет никакого отношения к этому проекту.
